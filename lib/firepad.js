...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    this.showEmojiPicker = this.getOption('showEmojiPicker', false);
  ...
  Firepad.prototype.addToolbar_ = function() {
    this.toolbar = new RichTextToolbar(this.imageInsertionUI, this.showEmojiPicker);
  ...
  Firepad.prototype.initializeKeyMap_ = function() {
    ...
    CodeMirror.keyMap["richtext"] = {
      ...
      "Shift-Cmd-X": binder(this.strike),
      ...
      "Shift-Cmd-7": binder(this.orderedList),
      "Shift-Cmd-8": binder(this.unorderedList),
      "Shift-Cmd-9": binder(this.todo),
      "Shift-Cmd-[": binder(this.align, 'left'),
      "Shift-Cmd-\\": binder(this.align, 'center'),
      "Shift-Cmd-]": binder(this.align, 'right'),
      fallthrough: ['default']
    };
  };
