...
firepad.RichTextToolbar = (function(global) {
  ...
  RichTextToolbar.prototype.makeButton_ = function(eventName, iconName) {
    ...
    utils.on(btn, 'mouseover', function() { showTooltip(`text-${eventName}`, btn); });
    utils.on(btn, 'mouseout', function() { hideTooltip(); });
    return btn;
  }
  ...
  RichTextToolbar.prototype.makeDropdown_ = function(title, eventName, items, value_suffix) {
    ...
    utils.on(button, 'mouseover', function() { showTooltip(`text-${eventName}`, button); });
    utils.on(button, 'mouseout', function() { hideTooltip(); });
